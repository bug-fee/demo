...
public class FTPUtil {
    ...
    public static void main(String[] args) throws IOException {
        FTPUtil ftpUtil = createFtpCli("192.168.43.234", "ftpuser", "1221", "/ftpuser");
        ftpUtil.setTimeout(60 * 1000, 60 * 1000, 60 * 1000);
        try {
            ftpUtil.connect();
            if (ftpUtil.isConnected()) {
                ftpUtil.upload("abc.png", new File("E:\\Temp\\time.png"));
            }
        }finally {
            ftpUtil.disconnect();
        }
